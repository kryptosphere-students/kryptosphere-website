...
const KryptosphereBlockchainSummit = lazy(() => import('./pages/KryptosphereBlockchainSummit'));
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route path="/kryptosphere-blockchain-summit" element={<KryptosphereBlockchainSummit />} />
