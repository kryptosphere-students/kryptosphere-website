        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-center items-center mb-12 w-full">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
              ...
              <div className="flex gap-2 overflow-x-auto flex-nowrap w-full md:w-auto justify-center pb-2 md:pb-0">
                {years.map((year) => (
                  <button
                    key={year}
                    onClick={() => setSelectedYear(year)}
                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 whitespace-nowrap min-w-fit ${
                      selectedYear === year
