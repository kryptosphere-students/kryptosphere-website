...
export const translations = {
  fr: {
    ...
    'board.subtitle': "Découvrez les passionnés qui font battre KRYPTOSPHERE® au quotidien. Des profils et des équipes diversifiées, complémentaires et motivées, unie par leur passion des cryptomonnaies depuis plus de 8 ans.",
