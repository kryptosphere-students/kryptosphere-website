...
export const translations = {
  fr: {
    ...
    'board.member5.role': 'Fondateur et administrateur',
    ...
    'board.member11.name': 'Emmanuelle MARQUETTE',
    ...
    'donation.transparencyText': 'Nous publions certains de nos rapports financiers pour assurer une transparence sur nos activités.',
