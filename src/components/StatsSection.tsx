...
export const translations = {
  fr: {
    ...
    'board.subtitle': "Découvrez les passionnés qui font vivre KRYPTOSPHERE au quotidien. Des équipes diversifiées, complémentaires et motivées, unie par leur passion des technologies et de l'informatique.",
